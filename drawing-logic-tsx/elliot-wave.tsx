...
export function drawElliotImpulseWave(
...
export function drawElliotCorrectionWave(
	startPoint: { x: number; y: number },
	endPoint: { x: number; y: number }
): WaveResult {
	const { x: x0, y: y0 } = startPoint;
...
export function drawElliotTriangleWave(
	startPoint: { x: number; y: number },
	endPoint: { x: number; y: number }
): WaveResult {
	const { x: x0, y: y0 } = startPoint;
...
export function drawElliotDoubleComboWave(
	startPoint: { x: number; y: number },
	endPoint: { x: number; y: number }
): WaveResult {
	const { x: x0, y: y0 } = startPoint;
...
export function drawElliotTripleComboWave(
	startPoint: { x: number; y: number },
	endPoint: { x: number; y: number }
): WaveResult {
	const { x: x0, y: y0 } = startPoint;
